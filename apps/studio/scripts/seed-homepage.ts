      ...
      packages: [
        {
          ...
          price: 99.99,
          duration: '~1.5 hr',
          description: 'Hand washing, spray waxing, trim and tire dressing, interior and plastic wiping, vacuuming, and cabin cleaning. $120 for trucks/SUVs.',
          includes: [
            'Hand washing',
            'Spray waxing',
        ...
        },
        {
          ...
          price: 180,
          duration: '~2.5 hr',
          description: 'Machine waxing or sealant application with steam cleaning, deep interior work, leather conditioning, and carpet extraction. $249.99 for trucks/SUVs.',
          includes: [
        ...
        },
        {
          ...
          price: 275,
          duration: '~4 hr',
          description: 'Clay bar treatment, waxing, and sealant application plus engine bay service, light scratch removal, and comprehensive detailing. $300 for trucks/SUVs. Headlight restoration add-on available for $50.',
          includes: [
            'Clay bar treatment',
